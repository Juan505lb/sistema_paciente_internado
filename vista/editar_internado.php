...
<?php include '../include/header.php';?>
  ...
  <div class="p-2">
<h1 class="text-center text-info"><strong>Formulario para editar paciente</strong></h1>
<hr>

<form action="../control/paciente/p_editar_paciente.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      <label><strong>Responsable del paciente</strong></label>
      <div class="input-group">
        <div class="input-group-prepend">
    ...
    <div class="form-group col-md-4">
      ...
      <div class="input-group">
        ...
        <option value="permiso" <?php if ($paciente['estado'] == 'permiso') echo 'selected'; ?>>Permiso</option>
        <option value="fuga" <?php if ($paciente['estado'] == 'fuga') echo 'selected'; ?>>Fuga</option>
        <option value="traslado" <?php if ($paciente['estado'] == 'traslado') echo 'selected'; ?>>Traslado</option>
        <option value="obito" <?php if ($paciente['estado'] == 'obito') echo 'selected'; ?>>Òbito</option>
    ...
    <div class="form-group col-md-4">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" value="<?php echo $paciente['judicial']; ?>" disabled>
      </div>
    </div>
    <div class="form-group col-md-4">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" value="<?php echo $paciente['ficha']; ?>" disabled>
      </div>
    </div>
    ...
    <div class="form-group col-md-4">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" value="<?php echo $paciente['diagnostico']; ?>" disabled>
      </div>
    </div>
    ...
    <button type="submit" class="btn btn-success mt-3">Actualizar Paciente</button>
