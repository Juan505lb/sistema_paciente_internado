...
<?php include '../include/header.php';?>
  <div class="p-1">
      <h1 class="text-center text-info"><strong>Formulario para editar detalle medico</strong></h1>
      <hr>
      <form action="../control/paciente/p_editar_detalle_medico.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="date" class="form-control" value="<?php echo $paciente['fecha_registro']; ?>"
              disabled>
          </div>
